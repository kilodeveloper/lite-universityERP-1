...
$sql="INSERT INTO student(name,regno,password,dob,studymode,course,phonenumber,postaddress,emailaddress,programme,semester) VALUES(:name,:regno,:password,:dob,:studymode,:course,:phonenumber,:postaddress,:emailaddress,:programme,:semester)";
$query = $dbh->prepare($sql);
$query->bindParam(':name',$name,PDO::PARAM_STR);
$query->bindParam(':regno',$regno,PDO::PARAM_STR);
$query->bindParam(':password',$password, PDO::PARAM_STR);
$query->bindParam(':dob',$dob, PDO::PARAM_STR);
$query->bindParam(':studymode',$studymode, PDO::PARAM_STR);
...
if($lastInsertId)
{
$msg="New UnderGraduate Student Successfully Admitted";
}
else 
{
...
<body class="cbp-spmenu-push">
	...
	<div class="cbp-spmenu cbp-spmenu-vertical cbp-spmenu-left" id="cbp-spmenu-s1">
		...
		<div id="page-wrapper">
			<div class="main-page">
				<div class="forms">
					<h2 class="title1">UnderGraduate Student Admission Panel</h2>
          ...
          <div class="form-group">
          <label class="col-sm-4 control-label">Pasword</label>
          ...
          <div class="form-group">
          <label class="col-sm-4 control-label">Study Mode</label>
