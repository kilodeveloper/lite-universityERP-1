...
$sql="INSERT INTO clearance(name,regno,dob,studymode,course,phonenumber,postaddress,emailaddress,programme) VALUES(:name,:regno,:dob,:studymode,:course,:phonenumber,:postaddress,:emailaddress,:programme)";
...
<body class="cbp-spmenu-push">
	...
	<div class="cbp-spmenu cbp-spmenu-vertical cbp-spmenu-left" id="cbp-spmenu-s1">
		...
		<div id="page-wrapper">
			<div class="main-page">
				<div class="forms">
					<h2 class="title1">Student Clearance Form</h2>
					<div class="form-grids row widget-shadow" data-example-id="basic-forms"> 
						<div class="form-title">
							<h4>Fill all Student Details :</h4>
						</div>
						<div class="form-body">
