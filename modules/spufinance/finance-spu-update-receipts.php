...
$sql="INSERT INTO receipts(refnumber,amount,name,regno) VALUES(:refnumber,:amount,:name,:regno)";
...
if($lastInsertId)
{
$msg=" Receipt  Successfully Registered";
}
else 
{
...
<section id="main-content">
	...
	<div class="form-w3layouts">
        ...
        <div class="row">
          ...
          <div class="form-group">
          <label class="col-sm-4 control-label">Student Registration Number</label>
