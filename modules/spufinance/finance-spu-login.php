...
$sql ="SELECT username,password FROM finance WHERE username=:username and password=:password";
...
echo "<script type='text/javascript'> document.location = 'finance-spu-dashboard.php'; </script>";
} else{
