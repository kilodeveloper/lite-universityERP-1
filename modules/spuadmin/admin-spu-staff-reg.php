...
$sql="INSERT INTO staff(name,staffno,password,email,department,phone) VALUES(:name,:staffno,:password,:email,:department,:phone)";
...
<section id="main-content">
	...
	<div class="form-w3layouts">
        ...
        <div class="row">
          ...
          <input type="submit" name="submit" Value="Register Staff"class="btn btn-success mr-2 ">
          </div>
          </form>
                            </div>
