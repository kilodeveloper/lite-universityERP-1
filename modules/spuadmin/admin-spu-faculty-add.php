...
$sql="INSERT INTO faculty(name,hod,description) VALUES(:name,:hod,:description)";
...
<section id="main-content">
	...
	<div class="form-w3layouts">
        ...
        <div class="row">
          ...
          <div class="form-group">
          <label class="col-sm-4 control-label">Head Of Faculty </label>
          <input type="text" name="hod" id="hod"  class="form-control" required="required" >
          </div>
          
          <div class="form-group">
          <label class="col-sm-4 control-label">Faculty Description</label>
          <input type="text" name="description" id="description"  class="form-control" required="required" >
          </div>   

          <div class="col-sm-6 col-sm-offset-4">
          <input type="submit" name="submit" Value="Add Faculty"class="btn btn-success mr-2 ">
          </div>
          </form>
                            </div>
