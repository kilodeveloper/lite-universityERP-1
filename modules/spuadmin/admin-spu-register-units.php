...
$sql="INSERT INTO unit(name,code,faculty) VALUES(:name,:code,:faculty)";
...
<section id="main-content">
	...
	<div class="form-w3layouts">
        ...
        <div class="row">
          ...
          <input type="submit" name="submit" Value="Add Units"class="btn btn-success mr-2 ">
          </div>
          </form>
                            </div>
