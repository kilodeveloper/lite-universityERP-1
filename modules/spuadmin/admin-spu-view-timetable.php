      ...
      <table class="table table-stripped" ui-jq="footable" ui-options='{
        ...
        <thead>
          <tr>
            ...
            <th data-breakpoints="xs sm md" data-title="day">Day</th>
            <th data-breakpoints="xs sm md" data-title="Time">Time</th>
            <th data-breakpoints="xs sm md" data-title="Roomno">Room Number</th>
          </tr>
        </thead>
        <tbody>
...
{				?>	
											...
											<td><?php echo htmlentities($result->unitname);?></td>
											<td><?php echo htmlentities($result->unitcode);?></td>
