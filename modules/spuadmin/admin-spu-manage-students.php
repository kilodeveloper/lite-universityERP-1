...
{				?>
                                            ...
                                            <td>
<a href="admin-spu-manage-students.php?del=<?php echo $result->id;?>" onclick="return confirm('Do You Want To Delete  A Student Record');">&nbsp;&nbsp;<i class="fa fa-trash-o"></i></a></td>
          </tr>
        </tbody>
        <?php $cnt=$cnt+1; }} ?>
      </table>
